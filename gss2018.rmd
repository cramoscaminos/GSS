...
Both variables are categorical; each with two levels OWNGUN Yes or No? so we will use the cat~cat analysis, chi-squared test independence, we will use the Fisher exact test for odd ratio. 
...
People who own guns are 75.68 in favor of capital punishment; while 24.32 of gun owners oppose capital punishment. 
...
I reject the  $H_0$ null hypothesis and accept the alternative. The p-value is less than 0.05. 
The p-value is 0.02022. People who own guns are 2.2x more likely to favor capital punishment. 
